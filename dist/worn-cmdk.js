...
var ii = /* @__PURE__ */ dr("<small class=\"svelte-jgcga6\"> </small>"), ai = /* @__PURE__ */ dr("<li role=\"presentation\"><button type=\"button\" role=\"option\"><span> </span> <!></button></li>"), oi = /* @__PURE__ */ dr("<li class=\"cmdk-group-label svelte-jgcga6\" role=\"separator\"> </li> <!>", 1), si = /* @__PURE__ */ dr("<li class=\"cmdk-empty svelte-jgcga6\" role=\"option\" aria-selected=\"false\">No matches.</li>"), ci = /* @__PURE__ */ dr("<dialog class=\"cmdk svelte-jgcga6\" aria-label=\"Command palette\"><div class=\"cmdk-search-row svelte-jgcga6\"><input class=\"cmdk-input svelte-jgcga6\" type=\"text\" autocomplete=\"off\" spellcheck=\"false\" aria-label=\"Command palette search\" role=\"combobox\" aria-expanded=\"true\" aria-controls=\"cmdk-list\"/> <button type=\"button\" class=\"cmdk-close svelte-jgcga6\" aria-label=\"Close command palette\"></button></div> <ul id=\"cmdk-list\" class=\"cmdk-list svelte-jgcga6\" role=\"listbox\" aria-label=\"Results\"><!> <!> <!></ul></dialog>"), li = {
	hash: "svelte-jgcga6",
	code: "\n	@keyframes svelte-jgcga6-cmdk-in {\n		from { opacity: 0; transform: translateY(-6px); }\n		to { opacity: 1; transform: translateY(0); }\n	}.cmdk.svelte-jgcga6 { animation: svelte-jgcga6-cmdk-in 0.15s ease-out;width:min(520px, 92vw);max-width:92vw;padding:0;border:1px solid var(--cmdk-border, var(--worn-border-strong, #d0cac1));border-radius:var(--cmdk-radius, 8px);background:var(--cmdk-surface, var(--worn-surface, #fff));color:var(--cmdk-text, var(--worn-text, #21322b));box-shadow:0 12px 40px rgba(0,0,0,0.3);margin:12vh auto auto;}.cmdk.svelte-jgcga6::backdrop {background:var(--cmdk-backdrop, rgba(0,0,0,0.45));}.cmdk-search-row.svelte-jgcga6 {display:flex;align-items:center;border-bottom:1px solid var(--cmdk-border, var(--worn-border, #e2ddd5));padding-right:4px;}.cmdk-input.svelte-jgcga6 {flex:1;min-width:0;box-sizing:border-box;border:0;background:transparent;color:inherit;font:inherit;font-size:16px;padding:14px 8px 14px 16px;}.cmdk-input.svelte-jgcga6::placeholder {color:var(--cmdk-text-muted, var(--worn-text-muted, #63746a));opacity:1;}.cmdk-input.svelte-jgcga6:focus-visible {outline:2px solid var(--cmdk-focus, var(--worn-focus, var(--worn-accent, currentColor)));outline-offset:-2px;}.cmdk-close.svelte-jgcga6 {position:relative;flex:0 0 auto;width:44px;height:44px;padding:0;border:0;border-radius:50%;background:transparent;color:var(--cmdk-text-muted, var(--worn-text-muted, #63746a));cursor:pointer;}.cmdk-close.svelte-jgcga6::before, .cmdk-close.svelte-jgcga6::after {content:'';position:absolute;left:50%;top:50%;width:12px;height:1.5px;border-radius:1px;background:currentColor;}.cmdk-close.svelte-jgcga6::before {transform:translate(-50%, -50%) rotate(45deg);}.cmdk-close.svelte-jgcga6::after {transform:translate(-50%, -50%) rotate(-45deg);}\n	@media (hover: hover) and (pointer: fine) {.cmdk-close.svelte-jgcga6:hover {background:var(--cmdk-selected-bg, var(--worn-hover-bg, #d7efe7));}\n	}.cmdk-close.svelte-jgcga6:focus-visible {outline:2px dashed var(--cmdk-focus, var(--worn-focus, var(--worn-accent, currentColor)));outline-offset:2px;}.cmdk-list.svelte-jgcga6 {list-style:none;margin:0;padding:6px;max-height:46vh;overflow-y:auto;}.cmdk-item.svelte-jgcga6 {display:flex;align-items:baseline;justify-content:space-between;gap:12px;padding:8px 10px;border-radius:var(--cmdk-radius-sm, 6px);cursor:pointer;width:100%;border:0;background:transparent;color:inherit;font:inherit;font-size:14px;text-align:left;}.cmdk-item.is-active.svelte-jgcga6 {background:var(--cmdk-selected-bg, var(--worn-hover-bg, #d7efe7));}.cmdk-item.svelte-jgcga6 small:where(.svelte-jgcga6) {color:var(--cmdk-text-muted, var(--worn-text-muted, #63746a));font-size:11px;white-space:nowrap;}.cmdk-group-label.svelte-jgcga6 {padding:8px 10px 4px;font-size:10px;font-weight:600;text-transform:uppercase;letter-spacing:0.04em;color:var(--cmdk-text-muted, var(--worn-text-muted, #63746a));}.cmdk-empty.svelte-jgcga6 {padding:12px 10px;color:var(--cmdk-text-muted, var(--worn-text-muted, #63746a));font-size:13px;}\n	@media (pointer: coarse) {.cmdk-item.svelte-jgcga6 {min-height:44px;} }\n	@media (prefers-reduced-motion: reduce) {.cmdk.svelte-jgcga6 { animation: none;} }"
};
function ui(e, t) {
	Ve(t, !0), Nr(e, li);
